...
HIGHLEVEL_FILES = [f"{HIGHLEVEL_URL}acousticbrainz-highlevel-json-20220623-{i}.tar.zst" for i in range(NUM_FILES)]
FEATURE_FILES = [f"{FEATURES_URL}acousticbrainz-lowlevel-features-20220623-{k}.tar.zst" for k in ("lowlevel", "rhythm", "tonal")]
