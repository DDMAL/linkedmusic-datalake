...
- Please read the [official documentation on Basic MusicBrainz Entities](//http://musicbrainz.org/doc/Terminology) as well as the [official table of MusicBrainz Relationships](https://musicbrainz.org/relationshipshttps:/)
...
4. **Extracting and Reconciling Unreconciled Fields**
   ...
   - EXCEPTION 2: `recording` entities do not have a `type` field.
