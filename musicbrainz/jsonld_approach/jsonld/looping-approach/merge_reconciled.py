...
def add_context(data):
    for i in data:
        i["@context"] = [i["@context"],"https://raw.githubusercontent.com/ddmal/linkedmusic-datalake/main/musicbrainz/jsonld_approach/jsonld/looping-approach/context.jsonld"]
